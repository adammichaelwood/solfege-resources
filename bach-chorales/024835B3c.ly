...
AvoiceEA = \relative c{
    ...
    cis8 b cis4 fis, fis'      | % 2
    gis a8 b cis4 cis,      | % 3
    fis8 e d cis d b e e,      | % 4
    a a' gis fis~ fis eis fis d      | % 5
    b gis cis4 fis, fis'8 e      | % 6
    d cis bis4 cis a      | % 7
    b8 cis dis b e4 eis8 cis      | % 8
    fis fis, fis' d g g, gis' e      | % 9
    a a, ais' fis b b, bis' gis      | % 10
    cis b cis cis, fis,4 s4 \bar "|." 
}% end of last bar in partorvoice
...
\part AvoiceEA { \quotearticulations \AvoiceEA \ASvoiceAA } { \transpose a c \AvoiceEA }
>>
}
\score {
<<
